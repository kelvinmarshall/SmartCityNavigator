...
public class FragmentParks extends Fragment {
    ...
    public FragmentParks() {
    }

    @SuppressLint("ValidFragment")
    public FragmentParks(int color) {
        this.color = color;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<Model_Parks> options =
                new FirebaseRecyclerOptions.Builder<Model_Parks>()
                        .setQuery(query, Model_Parks.class)
                        .build();

        adapter = new FirebaseRecyclerAdapter<Model_Parks, ViewHolderPlaces>(options) {
            @Override
            ...
            @Override
            protected void onBindViewHolder(final ViewHolderPlaces holder, int position, final Model_Parks model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent intent=new Intent(getActivity(),Detail_Parks.class);
    ...
    private void addOrRemoveToSaved(String id, boolean isAdd, Model_Parks model) {
