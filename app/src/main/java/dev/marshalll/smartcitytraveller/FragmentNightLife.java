...
public class FragmentNightLife extends Fragment {
    ...
    public FragmentNightLife() {
    }

    @SuppressLint("ValidFragment")
    public FragmentNightLife(int color) {
        this.color = color;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<Model_Nightlife> options =
                new FirebaseRecyclerOptions.Builder<Model_Nightlife>()
                        .setQuery(query, Model_Nightlife.class)
                        .build();

        adapter = new FirebaseRecyclerAdapter<Model_Nightlife, ViewHolderPlaces>(options) {
            @Override
            ...
            @Override
            protected void onBindViewHolder(final ViewHolderPlaces holder, int position, final Model_Nightlife model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent intent=new Intent(getActivity(),DetailNightlife.class);
    ...
    private void addOrRemoveToSaved(String id, boolean isAdd, Model_Nightlife model) {
