...
public class FragmentHotel extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Query query = FirebaseDatabase.getInstance()
                .getReference()
                .child("Hotel_restaurant")
                .limitToLast(50);

        FirebaseRecyclerOptions<Model_Hotel> options =
                new FirebaseRecyclerOptions.Builder<Model_Hotel>()
                        .setQuery(query, Model_Hotel.class)
                        .build();



        adapter = new FirebaseRecyclerAdapter<Model_Hotel,ViewHolderPlaces >(options) {
            @Override
            ...
            @Override
            protected void onBindViewHolder(final ViewHolderPlaces holder, final int position, final Model_Hotel model) {
    ...
    private void addOrRemoveToSaved(String id, boolean isAdd, Model_Hotel model) {
